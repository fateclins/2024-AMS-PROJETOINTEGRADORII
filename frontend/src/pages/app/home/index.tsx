...
export function Home() {
  return (
    <div className="relative overflow-hidden h-screen bg-[#22262B] p-8 flex items-center w-full mx-auto">
          ...
          <div className='flex items-start justify-center w-full'>
            <div className="max-w-md text-left">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                ...
                <a
                  href="../../register"                  
                  className="px-10 py-2.5 text-lg font-semibold text-white shadow-sm hover:bg-gray-900 border border-white rounded-md"
                >
                  Cadastrar-se
                </a>  
