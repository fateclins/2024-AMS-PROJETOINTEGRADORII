...
import {
  ...
  selectVariationDescriptionsAction,
...
export interface VariationDescriptionsContextTypes {
  ...
  selectVariationDescriptions(data: VariationDescriptionReducerType): void;
...
export function VariationDescriptionsProvider({ children }: VariationDescriptionsProviderProps) {
  ...
  function selectVariationDescriptions(data: VariationDescriptionReducerType) {
    variationDescriptionsDispatcher(selectVariationDescriptionsAction(data));
  }
