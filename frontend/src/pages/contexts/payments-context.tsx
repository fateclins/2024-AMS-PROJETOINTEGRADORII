...
export interface PaymentsContextTypes {
  ...
  selectPayments(data: PaymentReducerType): void;
...
export function PaymentsProvider({ children }: PaymentsProviderProps) {
  ...
  function selectPayments(data: PaymentReducerType) {
    paymentsDispatcher(selectPaymentsAction(data));
  }
